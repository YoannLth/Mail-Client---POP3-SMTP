 ...
 * @author yannick
 */
public class ContextPOP3
{
    private SSLSocket socket;
    private int port;
    private String ip;
    private String timestamp;
    private static ContextPOP3 instance;
    
    public static ContextPOP3 getInstance()
    {
        if(ContextPOP3.instance == null)
        {
            ContextPOP3.instance = new ContextPOP3();
        }
        return ContextPOP3.instance;
    }
    ...
    public void close()
    {
        ...
        {
            Logger.getLogger(ContextPOP3.class.getName()).log(Level.SEVERE, null, ex);
        }
    }  
